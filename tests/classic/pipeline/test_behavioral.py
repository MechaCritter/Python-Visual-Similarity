"""Behavioural / requirement-driven tests for :class:`pyvisim.classic.Pipeline`."""
...
#: PCA variants for the pipeline behavioural test (mirrors the embedder fixtures).
...
def test_identical_image_near_perfect_similarity(
    ...
    pipeline = Pipeline([learned_vlad_embedder, learned_fisher_embedder])
