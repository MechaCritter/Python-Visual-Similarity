"""Tests for :class:`pyvisim.encoders._clustering.DiagCovarGaussianMixture`."""
...
def fitted_gmm() -> DiagCovarGaussianMixture:
    ...
    :returns: a fitted :class:`pyvisim.encoders._clustering.DiagCovarGaussianMixture`.
    """
...
def test_gmm_deprecated_alias_warns() -> None:
    ...
    import pyvisim.encoders._clustering as clustering
