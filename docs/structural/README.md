...
> [`pyvisim/structural/generate_benchmark.py`](../../pyvisim/structural/generate_benchmark.py) (see
...
experiment and per metric. Thread budget: `PYVISIM_NUM_THREADS=4`
with `num_workers=2`; every runtime is the wall-clock time of
one full scoring call (7 timed calls after one warm-up).
...
|---|---|---|---|---|
| 1 pair (512x512), 512x512 | `image_00226.jpg`, `image_03707.jpg` | 16.0 | 82.2 | 5.1x |
| 1 expanded pair (1024x1024), 1024x1024 | `image_00150.jpg` | 134 | 526 | 3.9x |
| batch of 4 (16 pairs), 256x256 | `image_07561.jpg`, `image_02145.jpg`, `image_00112.jpg`, `image_07844.jpg` | 54.4 | 171 | 3.1x |
| batch of 8 (64 pairs), 256x256 | `image_04707.jpg`, `image_06877.jpg`, `image_05021.jpg`, `image_06347.jpg`, `image_00057.jpg`, `image_00507.jpg`, `image_01199.jpg`, `image_03657.jpg` | 226 | 689 | 3.0x |

![SSIM median runtime](benchmark/ssim_runtime_barplot.png)
...
| Scenario | Images | pyvisim (ms) | Baseline (ms) | Speed-up |
|---|---|---|---|---|
| 1 pair (512x512), 512x512 | `image_00037.jpg`, `image_06391.jpg` | 33.5 | 82.0 | 2.4x |
| 1 expanded pair (1024x1024), 1024x1024 | `image_00191.jpg` | 189 | 365 | 1.9x |
| batch of 4 (16 pairs), 256x256 | `image_00018.jpg`, `image_04460.jpg`, `image_00547.jpg`, `image_08160.jpg` | 134 | 355 | 2.7x |
| batch of 8 (64 pairs), 256x256 | `image_03502.jpg`, `image_04084.jpg`, `image_05542.jpg`, `image_00609.jpg`, `image_04044.jpg`, `image_07394.jpg`, `image_05554.jpg`, `image_02798.jpg` | 522 | 1,628 | 3.1x |

![MS-SSIM median runtime](benchmark/ms_ssim_runtime_barplot.png)
