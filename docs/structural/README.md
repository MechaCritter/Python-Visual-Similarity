...
> [`docs/structural/benchmarks/generate_benchmark.py`](benchmarks/generate_benchmark.py) (see
> [`benchmarks/benchmark_results.json`](benchmarks/benchmark_results.json) for
> the raw data); re-run
> `python docs/structural/benchmarks/generate_benchmark.py` to refresh it.
...
|---|---|---|---|---|
| 1 pair (512x512), 512x512 | `image_00226.jpg`, `image_03707.jpg` | 15.4 | 75.1 | 4.9x |
| 1 expanded pair (1024x1024), 1024x1024 | `image_00150.jpg` | 127 | 507 | 4.0x |
...
| Scenario | Images | pyvisim (ms) | Baseline (ms) | Speed-up |
|---|---|---|---|---|
| 1 pair (512x512), 512x512 | `image_00037.jpg`, `image_06391.jpg` | 31.1 | 75.4 | 2.4x |
| 1 expanded pair (1024x1024), 1024x1024 | `image_00191.jpg` | 174 | 325 | 1.9x |
