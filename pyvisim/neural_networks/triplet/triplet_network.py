...
from ..siamese.backbones import ResNetBackbone
...
class TripletNeuralNetwork(torch.nn.Module, SimilarityMetric):
    """
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        equals their dot product. During training this single shared-weight
        pass replaces the three explicit triplet branches: feed a labeled
        batch through it and mine the triplets online with
